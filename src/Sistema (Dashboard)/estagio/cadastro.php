      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <form role="form" method="GET" action="res_cadastro.php">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" maxlength="10"  name="ra" id="ra">
                  <script type="text/javascript"> /* script para mascara de cpf, gambiarra pra simplesmente bloquear input para apenas numeros, puxando das bibliotecas la em cima */
                  $("#ra").mask("0000000000");
                  </script>
                </div>
                <div class="form-group">
                  <label for="cpf">CPF</label>
                  <input type="text" class="form-control" maxlength="14" placeholder="000.000.000-00" name="cpf" id="cpf" >
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" maxlength="20" name="whatsapp" id="whatsapp" placeholder="+55 (00) 00000 0000">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="idAno">
