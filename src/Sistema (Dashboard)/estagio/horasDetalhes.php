      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-body">
              <a href="horasManual.php?ra=<?php echo $ra; ?>"><input type="button" class="btn btn-danger" value="Inserir horas manualmente"></a>
            </div>
            
            <div class="box-body">
            <a href="horasPeriodo.php?ra=<?php echo $ra; ?>"><input type="button" class="btn btn-primary" value="Ver o registro de horas por período"></a>
            </div>
