...
session_start();
  ...
  $acao = "Passou a turma de 1º Ano para o ano seguinte";
  $usuario = $logado;
...
<?php
  ...
  if (isset ($_GET['novo_ano'])){
    $sqlupdate = "UPDATE aluno SET idAno=2 WHERE idAno=1";
  ...
  ?>
    ...
    <?php
      ...
      echo '<script>
      alert("Turma atualizada para o 2° Ano com sucesso") 
      window.location.href = "listagemSegundoAno.php";
      </script>';
    }
    else{
      echo '<script>
      window.location.href = "listagemPrimeiroAno.php";
      </script>';
