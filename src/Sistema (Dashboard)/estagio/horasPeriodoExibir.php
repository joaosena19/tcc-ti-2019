        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <a href="horasPeriodoExibir_impressao.php?ra=<?php echo $ra; ?>&dataInicial=<?php echo $dataInicial; ?>&dataFinal=<?php echo $dataFinal; ?>"><button type="submit" class="btn btn-primary">Gerar relatório</button></a>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
